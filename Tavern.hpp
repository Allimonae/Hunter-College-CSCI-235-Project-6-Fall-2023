...
class Tavern : public ArrayBag<Character*>{
  public:
    ...
    */
    bool levelIsLess(Character* const character1, Character* const character2) const;

    /**
      @param: two Character pointers
      @return: true if the lhs Character's level is greater than the rhs Character's level
    */
    bool levelIsGreater(Character* const character1, Character* const character2) const;

    /**
      @param: two Character pointers
      @return: true if the lhs Character's vitality is less than the rhs Character's vitality
    */
    bool vitalityIsLess(Character* const character1, Character* const character2) const;

    /**
      @param: two Character pointers
      @return: true if the lhs Character's vitality is more than the rhs Character's vitality
    */
    bool vitalityIsGreater(Character* const character1, Character* const character2) const;
    ...
    */
    ...
    /**
      ...
      @post:  Print out the results of the action as described below:
              ...
              \n(ENEMY) [ENEMY NAME]: LEVEL [ENEMY LEVEL] [ENEMY RACE]. \nVITALITY: [ENEMY VITALITY] \nARMOR: [ENEMY ARMOR]\n 
    */
    void printActionResult(const std::string& action_name) const;
    ...
    */
    ...
    /**
            ...
            @post   : Do all of the following:
                    ...
                    : \n(YOU) [MAINCHARACTER NAME]: LEVEL [MAINCHARACTER LEVEL] [MAINCHARACTER RACE]. \nVITALITY: [MAINCHARACTER VITALITY] \nARMOR: [MAINCHARACTER ARMOR]\n
    */
    void enemyTurn(Character* const enemy);
    ...
    /**
      ...
      @post: After applying each action, print out the results of the action as follows:
              ...
              \n(YOU) [MAINCHARACTER NAME]: LEVEL [MAINCHARACTER LEVEL] [MAINCHARACTER RACE]. \nVITALITY: [MAINCHARACTER VITALITY] \nARMOR: [MAINCHARACTER ARMOR]\n
    */
    void printEnemyActionResult(const std::string& action_name) const;
