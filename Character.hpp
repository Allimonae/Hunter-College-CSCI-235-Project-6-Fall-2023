...
class Character
{
    public:
        ...
        */
        void strike(Character* const target);
        ...
        */
        void throwTomato(Character* const target);

        /**
            @return: the value stored in action_queue_
        */
        std::queue<int> getActionQueue() const;
